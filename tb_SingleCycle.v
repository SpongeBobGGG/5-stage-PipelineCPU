...
module tb_SingleCycle();
	...
	initial begin
		...
		/*
			...
			且為Little Endian編碼
		*/
		$readmemh("C:/FinalProject/instr_mem.txt", CPU.InstrMem.mem_array );
		$readmemh("C:/FinalProject/data_mem.txt", CPU.DatMem.mem_array );
		// 設定暫存器初始值，每一行為一筆暫存器資料
		$readmemh("C:/FinalProject/reg.txt", CPU.RegFile.file_array );
		#10;
		rst = 1'b0;
	end
